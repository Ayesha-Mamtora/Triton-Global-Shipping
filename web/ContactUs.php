...
<head>
	...
	<div class="contactus">
		...
		<div class="contact_content">
			<h3 style="margin-top: 30px; text-align: center">We'd Love to Help <br> We like to create things with fun, open-minded people. Feel free to say hello</h3>
		...
		<div>
			<div class="contact_content">
				<h3 style="margin-left: 8%"><u> CONTACT INFO </u></h3>
				<p>ADDRESS: Level 36, The Riparian Plaza 71 Eagle Street BRISBANE, QLD. 4000 AUSTRALIA</p>
				<p>EMAIL: info@tritonglobalshipping.com.au</p>
				<p>TELEPHONE Sri Lanka- +94 11 252 1394</p>
				<p>TELEPHONE Australia - +61 41 725 4352</p>
			</div>
	</div>
